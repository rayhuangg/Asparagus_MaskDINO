...
# ============== Single folder demo ===================
input_path='/home/rayhuang/photo_demo_used/Pseudo/20240205try/20210903/20210903_09_47_05_.jpg'
output_path='/home/rayhuang/photo_demo_used/Pseudo/20240205try/20210903/'
# output_path='/home/rayhuang/photo_demo_used'
...
input_path='/home/rayhuang/photo_demo_used/Pseudo/20240207try/'

# Define an array of dates in the format YYYYMMDD
dates=($(find "${input_path}" -maxdepth 1 -type d -exec basename {} \; | grep -v "20240207try" | sort))
